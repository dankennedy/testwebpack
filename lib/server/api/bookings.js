...
module.exports = function(api, config) {
    ...
    function createBooking(req, res, next) {
        ...
        Promise.join(PriceBand.getPriceForBooking(b),
            ...
            function(price, bookings) {
                ...
                if (BookingUtils.hasConflicts(b, bookings))
                    return res.status(409).send('Request conflicts with existing bookings');
    ...
    function getBooking(req, res, next) {
        Booking.findOneAsync({'_id': req.params.id})
            .then(function(b) {
                return !b ? res.status(404).send('Booking not found') : res.json(b);
            });
    }
            ...
            function(booking, voucher) {
                ...
                switch (voucher.discountType) {
                    ...
                    case 'percentdiscount':
                        booking.price = booking.price - (booking.price * voucher.percentDiscount);
                        break;
                    default:
