...
module.exports = function(router, log) {
    ...
    mdl.verifyP = function(params, settings) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            return requestP(req_options, body)
                .then(res => {
                    if (response === 'VERIFIED')
                        return resolve();
                    else
                        return reject(new Error('ipn: Response was not "VERIFIED" but was', response));
                })
        ...
        return new Promise(function (resolve, reject) {
            ...
            var req = https.request(options, function(res) {
                ...
                res.on('end', function() {
                    ...
                    log.debug('ipn: HTTPS response', result);
