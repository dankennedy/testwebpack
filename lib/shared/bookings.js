...
export class Booking{
    ...
    getCreatedDate() {
        return this.b.createdDate ? moment(this.b.createdDate) : moment();
    }
    ...
    getTotalPayments() {
        ...
        _.sum(this.b.payments, function(p) {
            return p.amount;
        });
    }

    getBalanceOutstanding() {
        let amount = this.price - this.getTotalPayments();
    ...
    isBalancePaid() {
        return this.getBalance() === 0 || this.getBalancePayment() !== null;
    }
    ...
    hasUsedVoucher() {
        return this.b.voucher && this.b.voucher._id.length;
    }
