...
module.exports = function(api, config) {
    ...
    function applyVoucher(req, res, next) {
        ...
        Promise.join(Booking.findByIdAsync(req.params.id),
                     Voucher.findByIdAsync(req.body.voucherCode),
            function(booking, voucher) {
                ...
                switch (voucher.discountType.toLowerCase()) {
                    ...
                    case 'percentdiscount':
                        ...
                        break;
                    default:
                        log.error('api.bookings: Unknown voucher discountType: ' + voucher.discountType);
    ...
    function getiCal(req, res, next) {
        Booking.findByIdAsync(req.params.id)
            .then(function(b) {
                ...
                var bookingLink = config.paymentlink + b._id,
